...
//===思路===
[2,1,-1]
=>[2,3,2] 從前面開始算每一個0~i的和
=>[2,0,-1] 從後面開始算(倒著算i~i-1)的和


[1,2,3]
=>[1,3,6]從前面開始算每一個0~i的和
=>[6,5,3]從後面開始算(倒著算i~i-1)的和


[1,7,3,6,5,6]
=>[1,8,11,17,22,28]從前面開始算每一個0~i的和
=>[28,27,20,17,11,6]從後面開始算(倒著算i~i-1)的和
